...
class Migration(migrations.Migration):
    ...
    replaces = [('teams', '0001_squashed_0004_alter_team_id_alter_team_members'), ('teams', '0005_alter_team_members_alter_team_projects')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(blank=True, related_name='teams', to='organizations_ext.organizationuser')),
            ],
            options={
